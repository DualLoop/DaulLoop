...
`AUTH_SMOKE_OK` and stops. It receives no discovery profiles, shared worlds, protected
registries, or outputs from other trials.
...
or generate a scientific candidate. Use `scripts.docker_smoke` for the
