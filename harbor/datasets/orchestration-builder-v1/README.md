...
released sequential strategy requests one candidate per episode.

After the coding agent stops, the controller replaces its networked container with a
clean offline container, then supplies the protected tests and registries. The
controller decides whether to retain the candidate for later episodes. Retention does
not establish novelty or constitute human approval.
