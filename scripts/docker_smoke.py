"""Test episode preparation and protected verification without a model."""
...
def main():
    ...
    parser.add_argument("--rq", type=int, choices=[1, 2, 3], default=1)
    parser.add_argument(
        "--collection", choices=["a", "b"], default="a", help="RQ3 starting collection"
    )
