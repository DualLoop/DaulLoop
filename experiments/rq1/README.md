# RQ1: profile-conditioned discovery

This directory contains the RQ1 campaign template. See the [RQ1
walkthrough](../../examples/rq1/README.md) for the paper context and run commands.

The agent receives one fixed `paper-semantic@0.3.0` card, all five short question
directions together, and the shared code examples. It invents a new world satisfying the
profile rather than implementing a supplied profile-specific program.
...
Read the [exact cards](../../foundry/discovery_profiles/paper-semantic/v0.3/) and [input
guide](../../docs/INPUTS.md). Each episode repeats the same card; accepted worlds and
the latest rejected candidate and report change independently per campaign.
