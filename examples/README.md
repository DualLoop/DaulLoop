# Run the paper's discovery experiments
...
| --- | --- | --- |
| §4.3 — RQ1: Construction | [Profile-conditioned discovery](rq1/README.md) | `bash examples/rq1/prepare.sh --agent codex --profile tracing --id rq1_demo` |
| §4.4 — RQ2: Controllability | [Image-support-steered discovery](rq2/README.md) | `bash examples/rq2/prepare.sh --agent claude --profile tracing --id rq2_demo --agent-seconds 1800` |
| §4.6 — RQ3: Evaluator guidance | [Model-feedback discovery](rq3/README.md) | `bash examples/rq3/prepare.sh --agent opencode --collection a --id rq3_demo` |
| §4.7 — RQ4: Downstream adaptation | [Not packaged](rq4/README.md) | No training launcher is included |
| §4.2 — Shared implementation examples | [Render without a model](shared_examples/README.md) | `bash examples/shared_examples/render.sh` |
...
`--profile all` prepares nine separate campaigns for RQ1/RQ2, one per profile. Launch
